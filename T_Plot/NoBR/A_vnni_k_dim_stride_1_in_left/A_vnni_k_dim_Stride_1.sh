#!/bin/bash
# DIESE FILE IST DIE GLEICHE WIE IN T_Plot/no_vnni_k_dim_stride_1_in_left/no_vnni_k_dim_Stride_1.sh nur das dort
# die VNNI-Optimierung NICHT aktiviert war.
